...
_lr_productions = [
  ...
  ('exp -> math_exp','exp',1,'p_exp','grammar.py',154),
  ('exp -> logic_exp','exp',1,'p_exp','grammar.py',155),
  ('exp -> assign','exp',1,'p_exp','grammar.py',156),
  ('read -> READ ( string )','read',4,'p_read','grammar.py',160),
  ('string -> ID','string',1,'p_string','grammar.py',164),
  ('string -> STRING','string',1,'p_string','grammar.py',165),
  ('math_exp -> term math_exp_alt','math_exp',2,'p_math_exp','grammar.py',169),
  ('math_exp_alt -> + term math_exp_alt','math_exp_alt',3,'p_math_exp_alt','grammar.py',173),
  ('math_exp_alt -> - term math_exp_alt','math_exp_alt',3,'p_math_exp_alt','grammar.py',174),
  ('math_exp_alt -> empty','math_exp_alt',1,'p_math_exp_alt','grammar.py',175),
  ('term -> factor term_alt','term',2,'p_term','grammar.py',179),
  ('term_alt -> * factor term_alt','term_alt',3,'p_term_alt','grammar.py',183),
  ('term_alt -> / factor term_alt','term_alt',3,'p_term_alt','grammar.py',184),
  ('term_alt -> empty','term_alt',1,'p_term_alt','grammar.py',185),
  ('factor -> ID','factor',1,'p_factor','grammar.py',189),
  ('factor -> number','factor',1,'p_factor','grammar.py',190),
  ...
  ('log_b -> call','log_b',1,'p_log_b','grammar.py',214),
  ('log_b -> bool','log_b',1,'p_log_b','grammar.py',215),
  ('log_b -> comparison','log_b',1,'p_log_b','grammar.py',216),
  ('bool -> TRUE','bool',1,'p_bool','grammar.py',220),
  ('bool -> FALSE','bool',1,'p_bool','grammar.py',221),
  ('comparison -> math_exp comparison_op math_exp','comparison',3,'p_comparison','grammar.py',225),
