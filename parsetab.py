...
_lr_productions = [
  ...
  ('params -> ( attrs )','params',3,'p_params','grammar.py',104),
  ('attrs -> attr attrs_alt','attrs',2,'p_attrs','grammar.py',109),
  ('attrs -> empty','attrs',1,'p_attrs','grammar.py',110),
  ('attrs_alt -> , attr attrs_alt','attrs_alt',3,'p_attrs_alt','grammar.py',118),
  ('attrs_alt -> empty','attrs_alt',1,'p_attrs_alt','grammar.py',119),
  ('func_block -> { statements return }','func_block',4,'p_func_block','grammar.py',127),
  ('statements -> statement statements','statements',2,'p_statements','grammar.py',131),
  ('statements -> empty','statements',1,'p_statements','grammar.py',132),
  ('statement -> if_block','statement',1,'p_statement','grammar.py',136),
  ('statement -> while_block','statement',1,'p_statement','grammar.py',137),
  ('statement -> for_block','statement',1,'p_statement','grammar.py',138),
  ('statement -> print_stmt','statement',1,'p_statement','grammar.py',139),
  ('statement -> expr','statement',1,'p_statement','grammar.py',140),
  ('assign -> var = exp','assign',3,'p_assign','grammar.py',144),
  ('init -> <empty>','init',0,'p_init','grammar.py',155),
  ('constructor_call -> ID ( args )','constructor_call',4,'p_constructor_call','grammar.py',159),
  ('prop -> THIS . ID','prop',3,'p_prop','grammar.py',169),
  ('prop -> ID . ID','prop',3,'p_prop','grammar.py',170),
  ('prop -> ID','prop',1,'p_prop','grammar.py',171),
  ('if_block -> IF ( exp exp_evaluation ) block','if_block',6,'p_if_block','grammar.py',193),
  ('if_block -> IF ( exp exp_evaluation ) block after_if_block ELSE block','if_block',9,'p_if_block','grammar.py',194),
  ('while_block -> WHILE ( leave_breadcrumb exp exp_evaluation ) block','while_block',7,'p_while_block','grammar.py',201),
  ('for_block -> FOR number FOR_TO number SKIP number block','for_block',7,'p_for_block','grammar.py',207),
  ('print_stmt -> PRINT ( exp ) ;','print_stmt',5,'p_print_stmt','grammar.py',211),
  ('return -> RETURN exp ;','return',3,'p_return','grammar.py',217),
  ('return -> empty','return',1,'p_return','grammar.py',218),
  ('block -> { statements }','block',3,'p_block','grammar.py',229),
  ('number -> FLOAT empty','number',2,'p_number','grammar.py',233),
  ('number -> INT','number',1,'p_number','grammar.py',234),
  ('expr -> exp ;','expr',2,'p_expr','grammar.py',246),
  ('exp -> read','exp',1,'p_exp','grammar.py',252),
  ('exp -> math_or','exp',1,'p_exp','grammar.py',253),
  ('exp -> assign','exp',1,'p_exp','grammar.py',254),
  ('exp -> string','exp',1,'p_exp','grammar.py',255),
  ('exp -> new','exp',1,'p_exp','grammar.py',256),
  ('string -> STRING','string',1,'p_string','grammar.py',261),
  ('read -> READ ( )','read',3,'p_read','grammar.py',268),
  ('math_exp -> term math_exp_alt','math_exp',2,'p_math_exp','grammar.py',273),
  ('math_exp_alt -> + term new_quad math_exp_alt','math_exp_alt',4,'p_math_exp_alt','grammar.py',280),
  ('math_exp_alt -> - term new_quad math_exp_alt','math_exp_alt',4,'p_math_exp_alt','grammar.py',281),
  ('math_exp_alt -> empty','math_exp_alt',1,'p_math_exp_alt','grammar.py',282),
  ('term -> factor term_alt','term',2,'p_term','grammar.py',289),
  ('term_alt -> * factor new_quad term_alt','term_alt',4,'p_term_alt','grammar.py',296),
  ('term_alt -> / factor new_quad term_alt','term_alt',4,'p_term_alt','grammar.py',297),
  ('term_alt -> empty','term_alt',1,'p_term_alt','grammar.py',298),
  ('new_quad -> empty','new_quad',1,'p_new_quad','grammar.py',304),
  ('factor -> id','factor',1,'p_factor','grammar.py',316),
  ('factor -> number','factor',1,'p_factor','grammar.py',317),
  ('factor -> call','factor',1,'p_factor','grammar.py',318),
  ('factor -> ( math_or )','factor',3,'p_factor','grammar.py',319),
  ('id -> ID','id',1,'p_id','grammar.py',327),
  ('math_or -> math_and math_or_alt','math_or',2,'p_math_or','grammar.py',334),
  ('math_or_alt -> OR math_and new_quad math_or_alt','math_or_alt',4,'p_math_or_alt','grammar.py',342),
  ('math_or_alt -> empty','math_or_alt',1,'p_math_or_alt','grammar.py',343),
  ('math_and -> math_comp math_and_alt','math_and',2,'p_math_and','grammar.py',349),
  ('math_and_alt -> AND math_comp new_quad math_and_alt','math_and_alt',4,'p_math_and_alt','grammar.py',356),
  ('math_and_alt -> empty','math_and_alt',1,'p_math_and_alt','grammar.py',357),
  ('math_comp -> math_exp math_comp_alt','math_comp',2,'p_math_comp','grammar.py',363),
  ('math_comp_alt -> comparison_op math_exp new_quad','math_comp_alt',3,'p_math_comp_alt','grammar.py',370),
  ('math_comp_alt -> empty','math_comp_alt',1,'p_math_comp_alt','grammar.py',371),
  ('comparison_op -> <','comparison_op',1,'p_comparison_op','grammar.py',377),
  ('comparison_op -> >','comparison_op',1,'p_comparison_op','grammar.py',378),
  ('comparison_op -> EQ','comparison_op',1,'p_comparison_op','grammar.py',379),
  ('comparison_op -> NE','comparison_op',1,'p_comparison_op','grammar.py',380),
  ('comparison_op -> LE','comparison_op',1,'p_comparison_op','grammar.py',381),
  ('comparison_op -> GE','comparison_op',1,'p_comparison_op','grammar.py',382),
  ('call -> prop ( args )','call',4,'p_call','grammar.py',387),
  ('call -> stack_call','call',1,'p_call','grammar.py',388),
  ('args -> exp args_aux','args',2,'p_args','grammar.py',394),
  ('args -> empty','args',1,'p_args','grammar.py',395),
  ('args_aux -> , exp args_aux','args_aux',3,'p_args_aux','grammar.py',403),
  ('args_aux -> empty','args_aux',1,'p_args_aux','grammar.py',404),
  ('stack_call -> ID . stack_method','stack_call',3,'p_stack_call','grammar.py',412),
  ('stack_method -> POP ( )','stack_method',3,'p_stack_method','grammar.py',418),
  ('stack_method -> PUSH ( id )','stack_method',4,'p_stack_method','grammar.py',419),
  ('stack_method -> PEEK ( )','stack_method',3,'p_stack_method','grammar.py',420),
  ('empty -> <empty>','empty',0,'p_empty','grammar.py',424),
  ('scope_class -> empty','scope_class',1,'p_scope_class','grammar.py',434),
  ('scope_function -> empty','scope_function',1,'p_scope_function','grammar.py',443),
  ('check_class -> empty','check_class',1,'p_check_class','grammar.py',452),
  ('neg_lookup -> empty','neg_lookup',1,'p_neg_lookup','grammar.py',458),
  ('store_attributes -> empty','store_attributes',1,'p_store_attributes','grammar.py',465),
  ('exp_evaluation -> empty','exp_evaluation',1,'p_exp_evaluation','grammar.py',473),
  ('after_if_block -> empty','after_if_block',1,'p_after_if_block','grammar.py',478),
  ('leave_breadcrumb -> empty','leave_breadcrumb',1,'p_leave_breadcrumb','grammar.py',484),
]
